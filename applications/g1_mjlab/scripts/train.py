"""Train G1 Teacher policy with PPO on mjlab."""
import sys
...
import src.tasks  # noqa: F401 — registers G1-Flat-v0
...
def main():
    ...
    parser.add_argument("--task-id", default="G1-Flat-v0")
    ...
    print(f"Training G1 Teacher: {args.num_envs} envs, {args.max_iterations} iters")
